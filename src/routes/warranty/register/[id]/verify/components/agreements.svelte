...
<div
  ...
  class="flex flex-col gap-3 mt-4 max-w-[90vw] md:max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg border border-mentor-gray
  {displayOnly ? 'max-h-[80vh]' : 'max-h-[70vh]'} overflow-y-auto"
>
  ...
  <div class="space-y-4 text-sm leading-relaxed">
    ...
    <div>
      ...
      <p class="text-gray-700 text-xs leading-5">
        ...
        英文品名/型號: "Mentor" MemoryGel Silicone Gel-Filled Breast Implants/ SMPX/SMHX/SHPX/SMPB/SMHB/SHPB<br
        />
        "Mentor" CPG Gel Breast Implants/ CPG331/332/333/321/322/323/333/311/3312/313
      </p>
    </div>
    ...
    <div>
      <h3 class="text-sm font-semibold text-mentor-primary mb-2">
        如患者有下列情形之一者，偉鉅股份有限公司及原廠壯生醫療器材股份有限公司得不負保固責任
      </h3>
      <p class="text-gray-700 text-xs leading-5">
    ...
    <div>
      <h3 class="text-sm font-semibold text-mentor-primary mb-2">其他條款：</h3>
      <p class="text-gray-700 text-xs leading-5">
...
{#if !displayOnly}
  <div class="flex justify-center mt-4 max-w-[90vw] md:max-w-4xl mx-auto">
    <label
  ...
  <div class="flex justify-center mt-4 max-w-[90vw] md:max-w-4xl mx-auto mb-4">
    <label
      class="flex items-start space-x-3 max-w-2xl"
      class:cursor-pointer={!agreementCheckboxDisabled}
      class:cursor-not-allowed={agreementCheckboxDisabled}
